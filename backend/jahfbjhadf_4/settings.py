"""
Django settings for jahfbjhadf_4 project.
...
ROOT_URLCONF = 'jahfbjhadf_4.urls'
...
WSGI_APPLICATION = 'jahfbjhadf_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jahfbjhadf_4 API",
    "DESCRIPTION": "API documentation for jahfbjhadf_4 App",
    "VERSION": "v1",
}
